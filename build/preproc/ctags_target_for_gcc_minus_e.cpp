# 1 "/home/hb/files/projects/esp/esp32/home-system/home-system.ino"
# 2 "/home/hb/files/projects/esp/esp32/home-system/home-system.ino" 2
# 3 "/home/hb/files/projects/esp/esp32/home-system/home-system.ino" 2
# 4 "/home/hb/files/projects/esp/esp32/home-system/home-system.ino" 2
# 5 "/home/hb/files/projects/esp/esp32/home-system/home-system.ino" 2
# 6 "/home/hb/files/projects/esp/esp32/home-system/home-system.ino" 2
...
#define WIFI_PASSWORD "8008000000"
...
UniversalTelegramBot bot("5305557231:AAGoACycqIlP5_P7vWps0tW9vMaCWgrvjnI", secured_client);
...
void securityDevice(void *parameters)
{
  ...
  while (true)
  {
    if (digitalRead(securityDevicePin) == 1)
    {
      ...
      if (state == 0x1 && emergency_State == "OFF")
      {
        latch = true;
        doorMotor.write(90);
...
void setup()
{
  ...
  Serial.println();
  syncMotor();
  pinMode(securityPin, 0x01);
  pinMode(lightsPin, 0x02);
  pinMode(securityDevicePin, 0x02);
  ...
  connectToNetwork("Ground_M", "8008000000");
  xTaskCreate(
      securityDevice, /* Task function. */
      "securityDevice", /* String with name of task. */
      10000, /* Stack size in bytes. */
      
# 486 "/home/hb/files/projects/esp/esp32/home-system/home-system.ino" 3 4
     __null
# 486 "/home/hb/files/projects/esp/esp32/home-system/home-system.ino"
         , /* Parameter passed as input of the task */
      1, /* Priority of the task. */
      
# 488 "/home/hb/files/projects/esp/esp32/home-system/home-system.ino" 3 4
     __null
# 488 "/home/hb/files/projects/esp/esp32/home-system/home-system.ino"
         ); /* Task handle. */
  /*
